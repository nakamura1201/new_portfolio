  ...
  <div class="c-snippets-content">
    <div class="c-snippets-content__inner">
            ...
            <div class="l-header__link" role="group" aria-label="グローバルナビとお問い合わせ">
              <nav class="l-header-nav" aria-label="グローバルナビ">
                <ul class="l-header-nav__list">
                  <li class="l-header-nav__list-item">home</li>
                  <li class="l-header-nav__list-item">サービス</li>
                  <li class="l-header-nav__list-item">会社案内</li>
                </ul>
              </nav>
      ...
      <div class="l-header-variations03">
        <header class="l-header l-header--has-border">
          <div class="l-header__inner">
            <div class="l-header__block l-header__block--left">
              <a href="/" class="l-header-logo-link" aria-label="トップへ">
                <img src="" width="120" height="40" loading="lazy" alt="サイトロゴ" class="l-header-logo">
              </a>
            </div>
            <button class="l-header-toggle" type="button" aria-controls="global-nav" aria-expanded="false">
              <span class="l-header-toggle__bar"></span>
              <span class="l-header-toggle__bar"></span>
              <span class="l-header-toggle__bar"></span>
              <span class="l-header-toggle__label">MENU</span>
            </button>
            <nav class="l-header-nav l-header-nav--center" id="global-nav" aria-label="グローバルナビ">
              <ul class="l-header-nav__list">
                <li class="l-header-nav__list-item"><a href="/">home</a></li>
                <li class="l-header-nav__list-item"><a href="/service/">サービス</a></li>
            ...
            <div class="l-header__block l-header__block--right">
              <div class="l-header-contact">
                <a href="/contact/" class="l-header-contact__btn">お問い合わせ</a>
              </div>
            </div>
          </div>
        </header>
